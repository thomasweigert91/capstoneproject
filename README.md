...
Trainify is a workout tracker app that allows you to track your progress and
explore different exercises. With Trainify, you can easily log and track your
workouts, set and track goals, and discover new exercises to try.

This app was developed using React and NextJS. It is optimized for mobile usage,
so be sure to switch to responsive mode on your browser for the best experience.
